function b64DecodeUnicode(str) {
    return decodeURICompoment(atob(str).split('').map(
...
function reject() {
    ...
    let vh = Math.max(document.documentElement.clientWidth ?? 0, window.innerHeight ?? 0)
...
document.getElementById("crushName").innterText = fcn;